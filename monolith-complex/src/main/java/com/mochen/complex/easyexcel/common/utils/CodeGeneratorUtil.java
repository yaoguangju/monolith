package com.mochen.complex.easyexcel.common.utils;
...
public class CodeGeneratorUtil {
    ...
    public static GlobalConfig globalConfig() {
        String outputDir = new File(System.getProperty("user.dir")) + "/monolith-complex/src/main/java";
    ...
    public static DataSourceConfig dataSourceConfig() {
        return new DataSourceConfig.Builder("jdbc:mysql://120.27.63.0:3306/monolith?serverTimezone=Asia/Shanghai&characterEncoding=UTF-8", "monolith", "y3whAM3CtdM2W88A")
